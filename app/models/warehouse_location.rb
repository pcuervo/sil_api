class WarehouseLocation < ActiveRecord::Base
  ...
  def locate_in_existing(item_location, quantity)
    ...
    WarehouseTransaction.create(inventory_item_id: item_location.inventory_item.id, warehouse_location_id: id, quantity: quantity, concept: WarehouseTransaction::ENTRY)
  ...
  def locate_in_new(inventory_item, quantity)
    ...
    item_location = ItemLocation.create(inventory_item_id: inventory_item.id, warehouse_location_id: id, quantity: quantity)
    item_locations << item_location
    WarehouseTransaction.create(inventory_item_id: inventory_item.id, warehouse_location_id: id, quantity: quantity, concept: WarehouseTransaction::ENTRY)
  ...
  def remove_item(inventory_item_id)
    ...
    WarehouseTransaction.create(inventory_item_id: inventory_item_id, warehouse_location_id: id, quantity: item_location.quantity, concept: WarehouseTransaction::WITHDRAW)
  ...
  def remove_quantity(inventory_item_id, quantity, concept = 3)
    ...
    item_location.save
    WarehouseTransaction.create(inventory_item_id: inventory_item_id, warehouse_location_id: id, quantity: quantity, concept: concept)
